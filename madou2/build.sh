...
# 
# madou2_introbuild script/ table/madou2_vwf_en.tbl out/script/
...
rawgrpconv_gg rsrc/compass_n.png rsrc/compass_structure_generic.txt $OUTROM $((0x22020+(0x20*0))) $OUTROM -p rsrc_raw/main_sprite_distinct.pal
rawgrpconv_gg rsrc/compass_w.png rsrc/compass_structure_generic.txt $OUTROM $((0x22020+(0x20*6))) $OUTROM -p rsrc_raw/main_sprite_distinct.pal
rawgrpconv_gg rsrc/compass_s.png rsrc/compass_structure_generic.txt $OUTROM $((0x22020+(0x20*12))) $OUTROM -p rsrc_raw/main_sprite_distinct.pal
rawgrpconv_gg rsrc/compass_e.png rsrc/compass_structure_generic.txt $OUTROM $((0x22020+(0x20*18))) $OUTROM -p rsrc_raw/main_sprite_distinct.pal
...
madou2_scriptbuild script/ table/madou2_en.tbl out/script/
...
mkdir -p "out/asm"
cp "$OUTROM" "asm/madou2.gg"

cd asm
  # apply hacks
  ../$WLADX -I ".." -o "main.o" "main.s"
  ../$WLALINK -s -v linkfile madou2_patched.gg
  
  mv -f "madou2_patched.gg" "madou2.gg"
  ...
  ../$WLALINK -v linkfile2 madou2_patched.gg
cd "$BASE_PWD"

mv -f "asm/madou2_patched.gg" "$OUTROM"
mv -f "asm/madou2_patched.sym" "$(basename $OUTROM .gg).sym"
rm "asm/madou2.gg"
rm "asm/main.o"
rm "asm/main2.o"
